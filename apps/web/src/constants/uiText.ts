export const UI_TEXT = {
  ...
  confirm: {
    ...
    startEngineMessage: '엔진을 시작하면 paper 실행용 신규 후보 평가가 재개됩니다.',
    stopEngineTitle: '엔진을 중지하시겠습니까?',
    stopEngineMessage: '엔진을 중지하면 paper 실행 평가와 자동 집행이 멈춥니다.',
    resetPaperTitle: 'Paper 계좌를 초기화하시겠습니까?',
    resetPaperMessage: '이 작업은 되돌릴 수 없습니다. 현재 paper 계좌 상태와 포지션이 초기화됩니다.',
...
export const REASON_CODE_KR: Record<string, string> = {
  ...
  needs_operator_review: '운영자 검토 필요',
  weak_quant: '퀀트 신호 약함',
