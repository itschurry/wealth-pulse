...
GET_ROUTES: tuple[Route, ...] = (
    ...
    Route(
        "/api/runtime/account",
        lambda _path, query: handle_runtime_account(_query_bool(query, "refresh", True)),
    ),
    Route("/api/runtime/engine/status", lambda _path, _query: handle_runtime_engine_status()),
    Route("/api/runtime/engine/cycles", lambda _path, query: handle_runtime_engine_cycles(query)),
    Route("/api/runtime/orders", lambda _path, query: handle_runtime_orders(query)),
...
POST_ROUTES: tuple[Route, ...] = (
    ...
    Route("/api/runtime/order", lambda _path, payload: handle_runtime_order(payload)),
    Route("/api/runtime/reset", lambda _path, payload: handle_runtime_reset(payload)),
    Route("/api/runtime/history/clear", lambda _path, payload: handle_runtime_history_clear(payload)),
    Route("/api/runtime/auto-invest", lambda _path, payload: handle_runtime_auto_invest(payload)),
    Route("/api/runtime/engine/start", lambda _path, payload: handle_runtime_engine_start(payload)),
    Route("/api/runtime/engine/pause", lambda _path, _payload: handle_runtime_engine_pause()),
    Route("/api/runtime/engine/resume", lambda _path, _payload: handle_runtime_engine_resume()),
    Route("/api/runtime/engine/stop", lambda _path, _payload: handle_runtime_engine_stop()),
